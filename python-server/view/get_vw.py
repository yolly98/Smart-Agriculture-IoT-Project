...
def print_configurations(config_list):
    ...
    for config in config_list:
        ...
        print("irr_limit        ", config[7])
        print("irr_duration:    ", config[8])
        print("mst_timer:       ", config[9])
        print("ph_timer:        ", config[10])
        print("light_timer:     ", config[11])
        print("tmp_timer:       ", config[12])
