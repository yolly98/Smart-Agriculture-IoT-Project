...
<simconf>
  ...
  <simulation>
    ...
    <mote>
      <interface_config>
        ...
        <x>98.05777136736931</x>
        <y>74.7284927481491</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>94.22529455884113</x>
        <y>93.47831346843275</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>3.901542353124062 0.0 0.0 3.901542353124062 -162.68189569450118 -133.64489437098143</viewport>
    </plugin_config>
    <width>400</width>
    <z>5</z>
    <height>400</height>
